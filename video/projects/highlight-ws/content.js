...
window.CONTENT = {
 "_note": "Canonical copy and media map for the eight-part, Story-native WS Highlight. Every public string is Australian English.",
 "theme": {
  "petrol": "#1E2F38",
  "deep": "#0F1A20",
  "off": "#F5F2F0",
 ...
 "servicesA": {
  ...
  "title": "One finishing package.",
  "photo": "peakhurst-7.jpg",
  "items": [
   "Rendering",
   "Decorative Finishes",
   "Painting",
 ...
 "systems": {
  ...
  "marks": [
   ...
   {
    "file": "pietra-marble.svg",
    "name": "Pietra Marble"
   },
   {
    "file": "mineral-fox.svg",
    "name": "Mineral Fox"
   },
   {
    "file": "basroc.svg",
